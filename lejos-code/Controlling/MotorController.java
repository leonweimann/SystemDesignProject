...
public class MotorController {
    ...
    private static final double DISTANCE_PER_ROTATION = 9.42478; // cm per full wheel rotation (example value)
    private static final double ROBOT_TRACK_WIDTH = 13.0; // Distance between the wheels in cm (example value)
